...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const params = {
            search_query,
            max_products: max_products ? parseInt(max_products) : 10,
            all_pages: all_pages === 'true',
            max_workers: max_workers ? parseInt(max_workers) : 8
        };
        const products = yield productService.getProducts(params);
        res.json({
            success: true,
            data: products,
 ...
 *         description: Internal server error
 */
router.post('/force-update', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
